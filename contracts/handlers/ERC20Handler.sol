...
contract ERC20Handler is IDepositExecute, HandlerHelpers, ERC20Safe {
    ...
    function init(address initBridgeAddress) external {
        require(!_initialised);
    ...
    */
    ...
    function executeProposal(
        ...
        address recipientAddress,
        uint256 amount
    ) external override(IDepositExecute) onlyBridge isInitialised {
        // uint256 amount;
    ...
    function withdraw(
        ...
        address recipient,
        uint256 amount
    ) external override(IERCHandler) onlyBridge isInitialised {
        require(_initialised);
